...
def model_cache(cacti_config_file, capacity, pgen_output):
    ...
    cacti_input.tech_param.sram_cell.I_off_n = 1e-12 if pgen_output.output_parameter.nmos.Isub == 0.0 else pgen_output.output_parameter.nmos.Isub
    cacti_input.tech_param.sram_cell.I_off_p = 1e-12 if pgen_output.output_parameter.pmos.Isub == 0.0 else pgen_output.output_parameter.pmos.Isub
    ...
    cacti_input.tech_param.peri_global.I_off_n = 1e-12 if pgen_output.output_parameter.nmos.Isub == 0.0 else pgen_output.output_parameter.nmos.Isub
    cacti_input.tech_param.peri_global.I_off_p = 1e-12 if pgen_output.output_parameter.pmos.Isub == 0.0 else pgen_output.output_parameter.pmos.Isub
...
def model_dram(cacti_config_file, pgen_output, mode=0):
    ...
    cacti_input.tech_param.dram_acc.I_off_n = 1e-12 if pgen_output["wl"].output_parameter.nmos.Isub == 0.0 else pgen_output["wl"].output_parameter.nmos.Isub
    cacti_input.tech_param.dram_acc.I_off_p = 1e-12 if pgen_output["wl"].output_parameter.pmos.Isub == 0.0 else pgen_output["wl"].output_parameter.pmos.Isub
    ...
    cacti_input.tech_param.dram_wl.I_off_n = 1e-12 if pgen_output["wl"].output_parameter.nmos.Isub == 0.0 else pgen_output["wl"].output_parameter.nmos.Isub
    cacti_input.tech_param.dram_wl.I_off_p = 1e-12 if pgen_output["wl"].output_parameter.pmos.Isub == 0.0 else pgen_output["wl"].output_parameter.pmos.Isub
    ...
    cacti_input.tech_param.peri_global.I_off_n = 1e-12 if pgen_output["hp"].output_parameter.nmos.Isub == 0.0 else pgen_output["hp"].output_parameter.nmos.Isub
    cacti_input.tech_param.peri_global.I_off_p = 1e-12 if pgen_output["hp"].output_parameter.pmos.Isub == 0.0 else pgen_output["hp"].output_parameter.pmos.Isub
